...
char *list_orientar_cruz2[6] = {
  "RRBUUbRR", "DDBRRbDD", "LLBDDbLL", "UUBLLbUU", "RRBBLLbbRR", "DDBBUUbbDD"
};
...
char *list_terminar_segundalinea[9] = {
  "RbrbuBU", "UbublBL", "LblbdBD", "DbdbrBR", "uBUBRbr", "rBRBDbd", "dBDBLbl",
  "lBLBUbu", "uBUBRbr"
};
...
char *list_armar_ultimacara2[8] =
    { "RBrBRBBr", "DBdBDBBd", "LBlBLBBl", "UBuBUBBu", "lbLblbbL", "ubUbubbU",
  "rbRbrbbR", "dbDbdbbD"
};
...
char *list_armar_ultimasesquinas[11] =
    { "B", "b", "B", "rUrDDRurDDRR", "dRdLLDrdLLDD", "lDlUULdlUULL",
  "uLuRRUluRRUU", "UrUlluRUlluu", "RdRuurDRuurr", "DlDrrdLDrrdd", "LuLddlULddll"
};
...
char *list_terminar_de_unavez[8] =
    { "RBrBRBBrubUbubbU", "DBdBDBBdrbRbrbbR", "LBlBLBBldbDbdbbD",
  "UBuBUBBulbLblbbL", "lbLblbbLUBuBUBBu", "ubUbubbURBrBRBBr",
      "rbRbrbbRDBdBDBBd", "dbDbdbbDLBlBLBBl"
};
