...
move_t traducir(move_t move,int giro)
{
    switch(giro) {
        case 1: return move;
        case 2: switch(move) {
            case mov_F : return mov_R;
            case mov_f : return mov_r;
            case mov_R : return mov_B;
            case mov_r : return mov_b;
            case mov_B : return mov_L;
            case mov_b : return mov_l;
            case mov_L : return mov_F;
            case mov_l : return mov_f;
            default    : return move;
        }
        case 3: switch(move) {
            case mov_F : return mov_B;
            case mov_f : return mov_b;
            case mov_R : return mov_L;
            case mov_r : return mov_l;
            case mov_B : return mov_F;
            case mov_b : return mov_f;
            case mov_L : return mov_R;
            case mov_l : return mov_r;
            default    : return move;
        }
        case 4: switch(move) {
            case mov_F : return mov_L;
            case mov_f : return mov_l;
            case mov_R : return mov_F;
            case mov_r : return mov_f;
            case mov_B : return mov_R;
            case mov_b : return mov_r;
            case mov_L : return mov_B;
            case mov_l : return mov_b;
            default    : return move;
        }
        case 5: switch(move) {
            case mov_F : return mov_U;
            case mov_f : return mov_u;
            case mov_R : return mov_R;
            case mov_r : return mov_r;
            case mov_B : return mov_D;
            case mov_b : return mov_d;
            case mov_L : return mov_L;
            case mov_l : return mov_l;
            case mov_U : return mov_B;
            case mov_u : return mov_b;
            case mov_D : return mov_F;
            case mov_d : return mov_f;
            default    : return move;
        }
        case 6: switch(move) {
            case mov_F : return mov_D;
            case mov_f : return mov_d;
            case mov_R : return mov_R;
            case mov_r : return mov_r;
            case mov_B : return mov_U;
            case mov_b : return mov_u;
            case mov_L : return mov_L;
            case mov_l : return mov_l;
            case mov_U : return mov_F;
            case mov_u : return mov_f;
            case mov_D : return mov_B;
            case mov_d : return mov_b;
            default    : return move;
        }
    }
...
move_t traducir2(move_t move,int giro)
{
    switch(giro) {
        case 2: switch(move) {
            case mov_U : return mov_L;
            case mov_u : return mov_l;
            case mov_R : return mov_U;
            case mov_r : return mov_u;
            case mov_D : return mov_R;
            case mov_d : return mov_r;
            case mov_L : return mov_D;
            case mov_l : return mov_d;
            default    : return move;
        }
        case 3: switch(move) {
            case mov_U : return mov_D;
            case mov_u : return mov_d;
            case mov_R : return mov_L;
            case mov_r : return mov_l;
            case mov_D : return mov_U;
            case mov_d : return mov_u;
            case mov_L : return mov_R;
            case mov_l : return mov_r;
            default    : return move;
        ...
        case 4: switch(move) {
            case mov_U : return mov_R;
            case mov_u : return mov_r;
            case mov_R : return mov_D;
            case mov_r : return mov_d;
            case mov_D : return mov_L;
            case mov_d : return mov_l;
            case mov_L : return mov_U;
            case mov_l : return mov_u;
            default    : return move;
        }
    }
